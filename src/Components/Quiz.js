...
const Quiz = () => {
  ...
  return (
    <div className="container quiz-container">
      ...
      <div className='col'>
                <h1>Flag Quiz</h1>
              <p className='quiz-start'>Click the correct flag image from the 4 images corresponding to the country name given below before the time is up.
              Use the icons to stop and/or resume the quiz.</p>
            <hr></hr>
